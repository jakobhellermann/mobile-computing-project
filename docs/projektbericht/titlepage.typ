...
#let titlepage(
  ...
  align(
    ...
    text(font: heading-font, weight: "regular", size: 14pt, doc-category),
  )

  text(font: heading-font, weight: "light", size: 36pt, fill: blue, doc-title)

  par(text(font: heading-font, abstract))
